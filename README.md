...
Данный репозиторий содержит в себе модель предсказания квалификационного времени круга гонщика Формулы 1. Полученная модель реализована в мобильном приложении [Apex](https://github.com/qum11ch/Apex)
